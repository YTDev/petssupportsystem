    ...
    <div className="w-72 rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
      ...
      <div className="p-4 border-t border-gray-200 bg-gray-50">
        <div className="flex gap-2 items-center">
          ...
          <button className="flex-1 px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none">
            Adopt Me
          </button>
        </div>
      </div>
